"""
Django settings for hillel_api project.
...
SECRET_KEY = "django-insecure-*llpc(@$03f5j1hr**f%$96$#@&l2vg9zo!v^wv6%bk=$7tm-f"
...
WSGI_APPLICATION = "hillel_api.wsgi.application"
